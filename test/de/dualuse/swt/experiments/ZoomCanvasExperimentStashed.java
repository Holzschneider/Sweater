...
public class ZoomCanvasExperimentStashed  extends LayerCanvas implements PaintListener, Listener, ControlListener {
...
//==[ Constructor ]=================================================================================
	...
	public ZoomCanvasExperimentStashed(Composite parent, int style) {
		super(parent, style);
...
//		super.addListener(MouseUp, this);
	...
	public ZoomCanvasExperimentStashed(Composite parent, int style, boolean constrained) {
		this(parent, style);
...
//==[ Events: Control Resized ]=====================================================================
	...
	@Override final public void controlResized(ControlEvent e) {
		...
		Rectangle currentSize = ZoomCanvasExperimentStashed.this.getBounds();
